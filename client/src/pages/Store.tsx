...
export default function Store() {
  ...
  function buyWithPoints(product: Product) {
    ...
    toast.success(`${product.points.toLocaleString()} points reserved for ${product.title}.`);
  }
