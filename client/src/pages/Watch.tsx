    ...
    <div className="page-stack">
      ...
      <section className="reward-layout">
        <div className="reward-card glass-card">
          ...
          <iframe title="A-ADS rewarded placement 2454518" data-aa="2454518" src="https://ad.a-ads.com/2454518?size=320x100" style={{ width: "320px", height: "100px", border: 0, display: "block", margin: "10px auto" }} />
